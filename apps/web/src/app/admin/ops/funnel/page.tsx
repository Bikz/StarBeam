...
import {
  updateInsightManualControls,
  updateWorkspaceProgram,
} from "@/app/admin/ops/funnel/actions";
...
export default async function AdminOpsFunnelPage({
  ...
  const activationSloEnabled = isActivationSloEnabled();

  const [summary, insights, allWorkspaces] = await Promise.all([
    ...
    <div className="sb-bg">
      <div className="mx-auto max-w-6xl px-6 py-16">
        <div className="sb-card p-8">
          ...
          {updated ? (
            <div className="mt-6 sb-alert">Program settings updated.</div>
          ) : null}
          {error ? (
          ...
          <div className="mt-8 grid gap-3 md:grid-cols-3">
            ...
            <div className="sb-card-inset p-4">
              ...
              <div className="mt-1 text-2xl font-extrabold">
                {summary.activation.firstPulseReady}
              </div>
              <div className="mt-2 text-xs text-[color:var(--sb-muted)]">
            ...
            <div className="sb-card-inset p-4">
              ...
              <div className="mt-1 text-2xl font-extrabold">
                {summary.activation.readyWithin24h}
              </div>
              <div className="mt-2 text-xs text-[color:var(--sb-muted)]">
          ...
          {activationSloEnabled ? (
            <div className="mt-8 grid gap-3 md:grid-cols-2">
              <div className="sb-card-inset p-4">
                ...
                <div className="mt-1 text-2xl font-extrabold">
                  {summary.chainCoveragePct.toFixed(1)}%
                </div>
                <div className="mt-2 text-xs text-[color:var(--sb-muted)]">
                  signed in users who reached Google connect, first pulse
                  queued, and first pulse ready
                </div>
              </div>
              <div className="sb-card-inset p-4">
                <div className="text-xs text-[color:var(--sb-muted)]">
                ...
                <div className="mt-2 text-xs text-[color:var(--sb-muted)]">
                  connected, no pulse:{" "}
                  <strong className="text-[color:var(--sb-fg)]">
          ...
          <div className="mt-8 grid gap-3 md:grid-cols-3">
            <div className="sb-card-inset p-4">
              ...
              <div className="mt-1 text-2xl font-extrabold">
                {summary.insightQuality.helpfulRatePct7d.toFixed(1)}%
              </div>
            </div>
            <div className="sb-card-inset p-4">
              <div className="text-xs text-[color:var(--sb-muted)]">
              ...
              <div className="mt-1 text-2xl font-extrabold">
                {summary.insightQuality.notHelpfulRatePct7d.toFixed(1)}%
              </div>
            </div>
            <div className="sb-card-inset p-4">
              <div className="text-xs text-[color:var(--sb-muted)]">
                Action completion (7d)
              </div>
              <div className="mt-1 text-2xl font-extrabold">
                {summary.insightQuality.actionCompletionRatePct7d.toFixed(1)}%
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 grid gap-3 md:grid-cols-2">
            <div className="sb-card-inset p-4">
              ...
              <div className="mt-2 text-xs text-[color:var(--sb-muted)]">
                executed:{" "}
                <strong className="text-[color:var(--sb-fg)]">
                  {insights.discoveredSkillRunner.executedCount}
                </strong>
              </div>
              <div className="mt-1 text-xs text-[color:var(--sb-muted)]">
                skipped by evaluator:{" "}
                <strong className="text-[color:var(--sb-fg)]">
                  {insights.discoveredSkillRunner.skippedByEvaluatorCount}
                </strong>
              </div>
              <div className="mt-1 text-xs text-[color:var(--sb-muted)]">
                helpful lift:{" "}
                <strong className="text-[color:var(--sb-fg)]">
                  {insights.discoveredSkillRunner.helpfulLiftPct.toFixed(1)}%
                </strong>
              </div>
              <div className="mt-1 text-xs text-[color:var(--sb-muted)]">
                action lift:{" "}
                <strong className="text-[color:var(--sb-fg)]">
                  {insights.discoveredSkillRunner.actionLiftPct.toFixed(1)}%
                </strong>
              </div>
            </div>
            <div className="sb-card-inset p-4">
              ...
              <div className="mt-2 text-xs text-[color:var(--sb-muted)]">
                discovered skill execution:{" "}
                <strong className="text-[color:var(--sb-fg)]">
                  {insights.manualControls.discoveredSkillExecutionEnabled
                    ? "enabled"
                    : "disabled"}
                </strong>
              </div>
              <form
                action={updateInsightManualControls}
                className="mt-3 grid gap-2"
              >
                <label className="inline-flex items-center gap-2 text-xs text-[color:var(--sb-muted)]">
                  <input
                    type="checkbox"
                    name="discoveredSkillExecutionEnabled"
                    defaultChecked={
                      insights.manualControls.discoveredSkillExecutionEnabled
                    }
                  />
                  Enable discovered skill execution
                </label>
                <label className="grid gap-1 text-xs text-[color:var(--sb-muted)]">
                  Disabled skill refs (comma or newline separated)
                  <textarea
                    name="disabledSkillRefs"
                    defaultValue={insights.manualControls.disabledSkillRefs.join(
                      "\n",
                    )}
                    rows={4}
                    className="sb-input p-2 font-mono text-[11px]"
                    placeholder="external.skill.name.v1"
                  />
                </label>
                <div>
                  <button
              ...
              <div className="mt-3 text-xs font-semibold text-[color:var(--sb-muted)]">
                Top persona submodes
              </div>
              {insights.bySubmode.length === 0 ? (
                <div className="mt-1 text-xs text-[color:var(--sb-muted)]">
                  none
                </div>
              ) : (
                <div className="mt-1 grid gap-1">
                  {insights.bySubmode.slice(0, 4).map((row) => (
                    <div
                      key={row.personaSubmode}
                      className="text-xs text-[color:var(--sb-muted)]"
                    >
                      {row.personaSubmode.toLowerCase().replaceAll("_", " ")} ·
                      helpful{" "}
                      <strong className="text-[color:var(--sb-fg)]">
                        {row.helpfulRatePct.toFixed(1)}%
                      </strong>
                    </div>
                  ))}
                </div>
          ...
          <div className="mt-8 grid gap-3 md:grid-cols-3">
            ...
            <div className="sb-card-inset p-4">
              ...
              <div className="mt-1 text-sm text-[color:var(--sb-muted)]">
                Prospect:{" "}
                <strong className="text-[color:var(--sb-fg)]">
                  {summary.designPartners.prospectCount}
                </strong>
              </div>
              <div className="mt-1 text-sm text-[color:var(--sb-muted)]">
                Active:{" "}
                <strong className="text-[color:var(--sb-fg)]">
                  {summary.designPartners.activeCount}
                </strong>
              </div>
              <div className="mt-1 text-sm text-[color:var(--sb-muted)]">
                Churned:{" "}
                <strong className="text-[color:var(--sb-fg)]">
                  {summary.designPartners.churnedCount}
                </strong>
              </div>
            </div>
          </div>
          ...
          <div className="mt-10">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <div className="text-xs font-extrabold sb-title">
                Design partner workspace usage
              </div>
              <div className="flex flex-wrap items-center gap-2">
                <Link
                ...
                <Link
                  ...
                  className={sbButtonClass({
                    variant:
                      programStatus === "PROSPECT" ? "primary" : "secondary",
                    className: "h-9 px-3 text-[11px] font-semibold",
                  })}
                >
                  Prospect
                ...
                <Link
                  ...
                  className={sbButtonClass({
                    variant:
                      programStatus === "ACTIVE" ? "primary" : "secondary",
                    className: "h-9 px-3 text-[11px] font-semibold",
                  })}
                >
                  Active
                ...
                <Link
                  ...
                  className={sbButtonClass({
                    variant:
                      programStatus === "CHURNED" ? "primary" : "secondary",
                    className: "h-9 px-3 text-[11px] font-semibold",
                  })}
                >
                  Churned
              ...
              <div className="mt-3 grid gap-2">
                {summary.byWorkspace.map((workspace) => (
                  <div
                    ...
                    className="sb-card-inset p-4 text-sm"
                  >
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      <div>
                        ...
                        <div className="mt-1 text-xs text-[color:var(--sb-muted)]">
                          ...
                          {workspace.programStatus.toLowerCase()} · start{" "}
                      ...
                      <div className="text-xs text-[color:var(--sb-muted)]">
                        WAU:{" "}
                        <strong className="text-[color:var(--sb-fg)]">
                          {workspace.weeklyActiveUsers}
                        </strong>{" "}
                        · Ready users:{" "}
                        <strong className="text-[color:var(--sb-fg)]">
                          {workspace.firstPulseReadyUsers}
                        </strong>{" "}
                        · Google users:{" "}
                        <strong className="text-[color:var(--sb-fg)]">
                          {workspace.googleConnectedUsers}
                        </strong>
                      </div>
                    </div>
                  </div>
                ...
                {summary.feedback.topCategories7d.map((row) => (
                  ...
                  >
                    <div className="flex items-center justify-between gap-3">
                      <span>
                        {row.category.toLowerCase().replaceAll("_", " ")}
                      </span>
          ...
          {activationSloEnabled ? (
            <div className="mt-10">
              ...
              {summary.activationBacklog.topFailureReasons.length === 0 ? (
                <div className="mt-3 text-sm text-[color:var(--sb-muted)]">
                  No failed first-pulse reasons in the last 24 hours.
                </div>
              ) : (
                <div className="mt-3 grid gap-2">
                  {summary.activationBacklog.topFailureReasons.map((row) => (
                    <div
                      key={row.reason}
                      className="sb-card-inset px-4 py-3 text-sm"
                    >
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        <span className="text-[color:var(--sb-fg)]">
                          {row.reason}
                        </span>
                        <strong>{row.count}</strong>
                      </div>
          ...
          <div className="mt-10">
            ...
            <div className="mt-3 grid gap-3">
              {allWorkspaces.map((workspace) => (
                <form
                  key={workspace.id}
                  action={updateWorkspaceProgram}
                  className="sb-card-inset p-4"
                >
                  <input
                    type="hidden"
                    name="workspaceId"
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                      <div className="font-semibold text-sm text-[color:var(--sb-fg)]">
                        {workspace.name}
                      </div>
                      <div className="text-xs text-[color:var(--sb-muted)]">
                        {workspace.slug}
                  ...
                  <div className="mt-3 grid gap-2 md:grid-cols-5">
                    <label className="text-xs text-[color:var(--sb-muted)] grid gap-1">
                      ...
                      <select
                        name="programType"
                        defaultValue={workspace.programType}
                    ...
                    <label className="text-xs text-[color:var(--sb-muted)] grid gap-1">
                      ...
                      <select
                        name="programStatus"
                        defaultValue={workspace.programStatus}
                        className="sb-input h-10 text-sm"
                      >
                        <option value="NONE">NONE</option>
