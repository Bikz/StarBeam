    ...
    <div className="grid gap-3">
      ...
      <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="sb-card p-7">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              ...
              <p className="mt-2 text-sm text-[color:var(--sb-muted)] leading-relaxed">
                This is the shared context Starbeam uses for web research
                prompts and department pulses.
              </p>
            </div>
          ...
          <form
            action={upsertWorkspaceProfile.bind(
              null,
        ...
        <div className="sb-card p-7">
          ...
          <div className="mt-3 grid gap-3 text-sm text-[color:var(--sb-muted)] leading-relaxed">
            ...
            <div>
              ...
              domains only (no paths). Starbeam will use this for “what changed
              in the last 72h?” web insight cards.
            </div>
          </div>
        </div>
      </div>
